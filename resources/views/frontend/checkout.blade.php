                    ...
                    <div class="cart">
                        ...
                        <div class="cart__checkout-process">
                            <ul>
                                <li>
                                    <p>Subtotal</p>
                                    <p>{{'RWF' . number_format((float) session('cart_details')['cart_total'] , 2)}}
                                    </p>
                                    {{-- {{ 'RWF' . (session('cart_details') && array_key_exists('cart_total',
